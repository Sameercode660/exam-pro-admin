...
export default function BatchList() {
  ...
  return (
    <>
      {
        (Number(typeId) == 0 ? (<PageHeading title="📦 Uploaded Questions Batches"></PageHeading>) : (Number(typeId) == 1 ? (<PageHeading title="📦 Uploaded Partcipants Batches"></PageHeading>) : (<PageHeading title="📦 Uploaded Added Group Participant Batches"></PageHeading>)))
      }
